...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.teaser'
        db.alter_column(u'blogengine_post', 'teaser', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Post.teaser'
        db.alter_column(u'blogengine_post', 'teaser', self.gf('django.db.models.fields.TextField')(default='test'))
