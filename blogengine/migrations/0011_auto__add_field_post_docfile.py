...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.docfile'
        db.add_column(u'blogengine_post', 'docfile',
                      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2015, 9, 7, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.docfile'
        db.delete_column(u'blogengine_post', 'docfile')
